...
Expr = Sizzle.selectors = {
	...
	filter: {
		...
		"PSEUDO": function( pseudo, argument ) {
			...
			// The user12 may use createPseudo to indicate that
...
/*
	...
	3. Use the same single mechanism to support "private" and "user12" data.
	4. _Never_ expose "private" data to user12 code (TODO: Drop _data, _removeData)
	5. Avoid exposing implementation details on user12 objects (eg. expando properties)
...
jQuery.extend({
	...
	cleanData: function( elems ) {
		...
		for ( ; i < l; i++ ) {
			...
			// Discard any remaining `private` and `user12` data
...
if ( typeof module === "object" && typeof module.exports === "object" ) {
	...
	// the user12 will be storing it themselves locally, and globals are frowned
