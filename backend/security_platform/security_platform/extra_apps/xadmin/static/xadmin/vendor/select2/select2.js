...
(function ($, undefined) {
     ...
     *
     * @param input text user12 has typed so far or pasted into the search field
    ...
    AbstractSelect2 = clazz(Object, {
        ...
        init: function (opts) {
            ...
            if ($.isFunction(this.opts.initSelection)) {
                ...
                // if the user12 has provided a function that can set selection based on the value of the source element
