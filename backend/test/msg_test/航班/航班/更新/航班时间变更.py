...
xxx = '<MSG><META><SNDR>FIMS</SNDR><RCVR/><SEQN>84</SEQN><DDTM>20201102092901</DDTM><TYPE>DFOE</TYPE><STYP>DFIE</STYP><SORC/><MGID>104ad6e1-3078-476f-9474-ddedd7718c9a</MGID><RMID/><APOT>ZUGY</APOT></META>' \
      '<DFLT>' \
      '<FLID>17063</FLID>' \
      '<FPTT>20211102080000</FPTT>' \
      '<FETT>20211102080000</FETT>' \
      '<FRTT>20211102080000</FRTT>' \
      '<FPLT>20211102080000</FPLT>' \
      '<FELT>20211102080000</FELT>' \
      '<FRLT>20211102080000</FRLT>' \
      '<FATT>MIX</FATT>' \
      '<TMCD><NMCD>T3</NMCD><JMCD/></TMCD>' \
      '</DFLT>' \
      '</MSG>'
